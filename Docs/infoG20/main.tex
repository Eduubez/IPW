...
\begin{document}
    ...
    O projeto foi orientado pelos docentes Pedro Miguel Florindo Miguens Matutino e Artur Jorge Ferreira.
    ...
    Uma vez que o repositório é privado, o acesso deverá ser solicitado a um dos elementos do grupo, através dos seguintes contactos:

    \begin{itemize}
        \item Eduardo Franco Bezerra -- a46362@alunos.isel.pt;
        \item Francisco Duarte Tavares -- a51618@alunos.isel.pt;
        \item Rafael Henrique Souza Reis -- a51870@alunos.isel.pt.
    \end{itemize}
    ...
    Para a versão beta, o desenvolvimento principal da aplicação encontra-se na branch \texttt{develop}.
