...
No segundo Capítulo descreve-se a solução proposta, incluindo a arquitetura do sistema, o modelo de dados e os principais aspetos de implementação das componentes \textit{backend} e \textit{frontend}.
