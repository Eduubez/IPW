...
Ao longo do desenvolvimento foi definida uma arquitetura composta por uma aplica\c{c}\~{a}o \textit{frontend}, uma \textit{API} \textit{backend}, uma base de dados relacional e um serviço de armazenamento. O \textit{frontend} disponibiliza a interface de utiliza\c{c}\~{a}o da plataforma, enquanto o \textit{backend} concentra a l\'{o}gica de neg\'{o}cio, a autentica\c{c}\~{a}o, a autoriza\c{c}\~{a}o e o acesso aos dados. A base de dados foi modelada de forma a representar os principais conceitos do dom\'{i}nio, incluindo utilizadores, pap\'{e}is, \'{a}reas, processos, estados e hist\'{o}rico.
