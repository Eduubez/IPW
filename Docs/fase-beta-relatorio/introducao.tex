...
\begin{itemize}
\item \textbf{Triador} — responsável pela receção dos pedidos de averiguação, criação de processos e pela sua atribuição aos averiguadores;
...
\textcolor{blue}{Com uma intrudução tão detalhada + objetivos, acreditamos que esta secção de requisitos seja redundante.}
