...
\textbf{TODO: colocar imagem da p\'{a}gina de login aqui.}
...
Quando dispon\'{i}vel, a tabela de processos serve como ponto de entrada para a consulta detalhada de cada processo. Esta abordagem permite que os utilizadores envolvidos no workflow acompanhem o estado dos processos de forma centralizada, reduzindo a depend\^{e}ncia de informa\c{c}\~{a}o dispersa por diferentes ficheiros ou canais de comunica\c{c}\~{a}o.
...
Esta p\'{a}gina permite concentrar num \'{u}nico local a informa\c{c}\~{a}o operacional do processo, facilitando o acompanhamento por parte dos diferentes pap\'{e}is envolvidos no workflow.
...
Em conjunto, estes fluxos demonstram a base funcional da plataforma IPW e a forma como a aplica\c{c}\~{a}o suporta a gest\~{a}o estruturada dos processos de averigua\c{c}\~{a}o.
