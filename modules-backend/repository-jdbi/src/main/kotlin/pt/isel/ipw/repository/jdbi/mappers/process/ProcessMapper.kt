...
class ProcessMapper(private val notes: List<Note>, private val activities: List<Activity>, private val proves: List<Prove>) : RowMapper<ProcessView> {
    override fun map(rs: ResultSet, ctx: StatementContext): ProcessView =
        ProcessView(
            ...
            priority = Priority.mapStringToPriority(rs.getString("priority")) ?: Priority.NORMAL,
