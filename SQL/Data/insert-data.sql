...
values ('Administrador', 'admin@ipw.pt', 'hash_admin_123', null),
...
values ('token_admin_001', 1, current_timestamp + interval '7 days'),
...
-- TYPIFICATION
-- =========================
insert into Typification (name, honorary)
values ('Automovel', 150.00),
...
insert into Process (name,
                     ...
                     investigator_id,
                     supervisor_id)
values ('Sinistro automovel - Jose Silva',
...
-- REPORT
-- =========================
insert into Report (process_id, content, created_at, updated_at)
values (1,
...
-- DILIGENCIA
-- =========================
insert into Diligencia (process_id,
                        investigator_id,
                        description,
                        status,
                        created_at,
